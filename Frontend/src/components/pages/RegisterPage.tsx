        ...
        <div className="w-full max-w-[360px]">
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <div>
              ...
              <input id="password" name="password" type="password" autoComplete="new-password" required value={password} onChange={(e) => setPassword(e.target.value)} className="w-full h-[54px] border border-[#d8d8d8] rounded-[4px] bg-white px-4 text-[16px] text-[#1d1d1d] transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#d45d00] focus:ring-offset-2 focus:border-[#d45d00]" />
            </div>
